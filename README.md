...
Recommended screenshots for the final project README:
...
```md
![Registration Pass](./screenshots/registration-pass.png)
```
...
- [x] Total workshop metric works
- [x] Total sponsor metric works
- [x] Registration metric works
- [x] Next workshop countdown works
- [x] Upcoming workshop section works
- [x] Dashboard animations work

## Notifications

- [x] Notifications appear correctly
- [x] Notifications can be dismissed
- [x] Dismissed notifications persist
- [x] Registration notifications work
- [x] Completion notifications work
- [x] Full-workshop warnings work

## Workshops

- [x] Workshop data displays correctly
- [x] Search works
- [x] Category filtering works
- [x] Status filtering works
- [x] Mode filtering works
- [x] Sorting works
- [x] View workshop works
- [x] Edit workshop works
- [x] Mark completed works
- [x] Completed workshops cannot be edited
- [x] Completed workshops hide remaining seats
- [x] Full workshops display correctly

## Watchlist

- [x] Add to watchlist works
- [x] Remove from watchlist works
- [x] Watchlist count works
- [x] Watchlist persists after reload
- [x] My Watchlist view works

## Registration

- [x] Three-step registration works
- [x] Personal information validation works
- [x] Academic email validation works
- [x] Year validation works
- [x] Department validation works
- [x] Workshop selection works
- [x] Full workshops cannot be selected
- [x] Duplicate registrations are blocked
- [x] Same email can register for another workshop
- [x] Capacity is checked during submission
- [x] Seats update without reload
- [x] Success state works

## Registration Pass

- [x] Registration ID generated dynamically
- [x] Registration information displayed
- [x] Workshop information displayed
- [x] Sponsor information displayed
- [x] Copy ID works
- [x] Download Pass works
- [x] Pass uses registration snapshot data
...
- [x] 320px layout works
- [x] 375px layout works
- [x] Tablet layout works
- [x] Desktop layout works
- [x] Mobile navigation works
- [x] Mobile workshop cards work
- [x] Responsive filters work
- [x] Registration form works on mobile
- [x] Registration pass works on mobile
- [x] No unwanted horizontal overflow

## Code Quality

- [x] No console errors
- [x] Production build passes
- [x] No unnecessary state library
- [x] No direct mutation of workshop data
- [x] Reusable components used
- [x] React state remains the source of truth
